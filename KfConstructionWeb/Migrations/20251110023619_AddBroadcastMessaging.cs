        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserMessageStatuses_BroadcastMessages_BroadcastMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BroadcastMessages_Active_SentAt",
                table: "BroadcastMessages",
                columns: new[] { "IsActive", "SentAt" });

            migrationBuilder.CreateIndex(
                name: "IX_BroadcastMessages_TargetRole",
                table: "BroadcastMessages",
                column: "TargetRole");

            migrationBuilder.CreateIndex(
                name: "IX_UserMessageStatuses_MessageId_IsRead",
                table: "UserMessageStatuses",
                columns: new[] { "BroadcastMessageId", "IsRead" });

            migrationBuilder.CreateIndex(
                name: "IX_UserMessageStatuses_UserId_IsRead",
                table: "UserMessageStatuses",
