        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnlockReason = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailLogs_Status_Type",
                table: "EmailLogs",
                columns: new[] { "Status", "EmailType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Testimonials_ServiceType",
                table: "Testimonials",
                column: "ServiceType");

            migrationBuilder.CreateIndex(
                name: "IX_Testimonials_Status_Featured_Order",
                table: "Testimonials",
